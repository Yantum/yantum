...
std::string GetWarnings(bool verbose)
{
    ...
    if (hashInvalidCheckpoint != ArithToUint256(arith_uint256(0)))
    {
        ...
        warnings_verbose += (strGUI.empty() ? "" : warning_separator) + _("WARNING: Inconsistent checkpoint found! Stop enforcing checkpoints and notify developers to resolve the issue.").translated;
    }
